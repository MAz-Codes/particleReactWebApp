                ...
                <Box
                    ...
                    <Grid gap="5vw" templateRows={`auto`} w="100%">
                        <Box text-align="left">
                            ...
                            <Text my={"1vw"} ml="1vw" fontSize={{ base: "sm", md: "15", lg: "17", xl: "20" }} textAlign="left">{t('research.paper.content')}<a color={"#bdc3c7"} href="https://www.dropbox.com/scl/fi/yq13hgpeu096kj8wqqwq6/Integrating-Digital-Competency-in-Music-Education_Misagh-Azimi.pdf?rlkey=pnqbfs4j2aptlwojeftx4rikz&dl=0" target='_blank'> &lt;/{t('contact.here')}&gt;.</a></Text>
                        </Box>
